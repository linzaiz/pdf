...
#                          
tables = camelot.read_pdf(r'C:\tmp\2021物.pdf', flavor='stream', pages="4", table_areas=[ '36,788,299,0', '300,788,585,0' ],
                          columns=['56.5, 180, 219, 239, 259', '328.5, 452, 491, 511, 531'],
                          row_tol=10, layout_kwargs={'word_margin': 0.03, 'char_margin': 0.1} )
print(tables)
